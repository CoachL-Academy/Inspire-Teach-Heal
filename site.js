...
(function () {
  ...
  function insertAds() {
    // Skip if page already has hardcoded ad units to avoid double injection
    if (document.querySelectorAll('ins.adsbygoogle').length > 0) return;
  ...
  function insertFooter() {
    ...
    footer.innerHTML =
      '<p style="margin-bottom:10px;">© 2025 Coach L Academy</p>' +
      '<div style="display:flex;flex-wrap:wrap;justify-content:center;gap:8px 18px;">' +
      '<a href="https://coachl-academy.github.io/privacy-policy.html" ' +
      'style="color:#a78bfa;text-decoration:none;white-space:nowrap;">Privacy Policy</a>' +
      '<a href="https://coachl-academy.github.io/terms-of-use.html" ' +
      'style="color:#a78bfa;text-decoration:none;white-space:nowrap;">Terms of Use</a>' +
      '<a href="https://coachl-academy.github.io/contact-us.html" ' +
      'style="color:#a78bfa;text-decoration:none;white-space:nowrap;">Contact Us</a>' +
      '<a href="https://coachl-academy.github.io/all-courses.html" ' +
      'style="color:#a78bfa;text-decoration:none;white-space:nowrap;">All Courses</a>' +
      '</div>';
